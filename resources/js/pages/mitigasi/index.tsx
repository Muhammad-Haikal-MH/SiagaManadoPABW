    ...
    <Navbar auth={auth} />
          <Layout>
                ...
                <div className="container mx-auto text-center px-4 pt-10 justify-items-center">
                    <h1 className="text-3xl font-bold text-[#1C398E] dark:text-[#F1F5F9]">Mitigasi Bencana Alam</h1>
                    <section className="grid grid-cols-1 md:grid-cols-3 justify-items-center gap-20 mt-8 justify-evenly ">
                        {mitigasiList.map((item) => (

                            <Link href={`/mitigasi/${item.slug}`} className="bg-[#CFE6FF] dark:bg-[#1E293B] p-6 h-60 w-64 rounded-2xl hover:scale-110 transition-transform duration-300">
