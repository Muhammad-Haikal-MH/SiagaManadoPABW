...
export default function LaporModal({ open, onClose }: any) {
    ...
    return (
            <Dialog open={open} onOpenChange={onClose}>
                <DialogContent className="max-w-xl md:w-[420px] md:h-[650px] p-5 rounded-xl bg-[#CFE6FF]">
                    <DialogHeader>
                        <DialogTitle className="text-[#1C398E]">Form Laporan Bencana</DialogTitle>
                    </DialogHeader>
                     ...
                     >
                        {({ processing, errors, recentlySuccessful }) => (
                            <div className="space-y-4 px-10">
                                ...
                                <Select name="jenis">
                                    <SelectTrigger className="border-0 border-b border-b-[#1C398E] cursor-pointer focus:rounded-lg text-[#1C398E] focus:border-b-blue-400 transition-all duration-200 focus:outline-none focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0">
                                        <SelectValue placeholder="Pilih jenis bencana" />
                                    </SelectTrigger>
                                    <SelectContent className="bg-[#CFE6FF] rounded-xl ">
                                ...
                                <textarea
                                    name="deskripsi"
                                    className="w-full border-0 border-b border-b-[#1C398E] focus:rounded-lg text-[#1C398E] focus:border-b-blue-400 transition-all duration-200 focus:outline-none focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0"
